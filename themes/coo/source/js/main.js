let Utils = (function () {
  return {
    LIBRARY: {
      fuse: {
        lib: [`${window.rel_url}/js/fuse_6.4.6.js`],
        instance: "Fuse",
        attr: { async: true },
      },
    },
...
window.addEventListener("load", () => {
  ...
  const searchEngine = function (options) {
    ...
    let defaultOptions = {
      ...
      container: "#mysearch",
      dbPath: `${window.rel_url}/search.json?v=1.0`,
    };
    this.container =
  ...
  searchEngine.prototype = {
    ...
    renderPreview() {
      ...
      document.querySelector(
        ".preview-panel"
      ).innerHTML = `<section class="w-full py-3 px-5">
                <div class="flex justify-center pt-1 pb-4">
                    <div class="flex justify-center items-center w-8 h-8 rounded ${
                      hit.background === undefined
                        ? "bg-emerald-500"
                        : hit.background
                    } shadow-lg">
                ...
                <div class="flex justify-center items-center font-medium flex-wrap dark:text-slate-200">${
                  hit.title
                }</div>
